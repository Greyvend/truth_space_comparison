...
\begin{biblio}
	...
	\BibEmph{Afrati,~Foto~N.} Rewriting queries using views in the presence of
	arithmetic comparisons. [Text]~/ Foto~N.~Afrati, Chen~Li, Prasenjit~Mitra~//
	...
	\bibitem{baralis}
	\selectlanguageifdefined{english}
	\BibEmph{Baralis,~Elena}. Materialized Views Selection in a Multidimensional
	Database [Text]~/ Elena~Baralis, Stefano~Paraboschi, Ernest~Teniente~//
	...
	\newblock P.~156--165. ---
	\newblock URL: \BibUrl{http://dl.acm.org/citation.cfm?id=645923.671019}.
	
	\bibitem{church}
	\selectlanguageifdefined{english}
	\BibEmph{Church,~Alonzo}. Introduction to Mathematical Logic [Text]~/
	Alonzo~Church. ---
	...
	\bibitem{date}
	\selectlanguageifdefined{english}
	\BibEmph{Date,~Christopher~J.} SQL and Relational Theory [Text]~/
	Christopher~J.~Date. ---
	...
	\bibitem{denny}
	\selectlanguageifdefined{english}
	\BibEmph{Denny,~Matthew}.
	\href{http://dx.doi.org/10.1145/1066157.1066231}{Predicate Result Range
		Caching for Continuous Queries} [Text]~/ Matthew~Denny,
	Michael~J.~Franklin~// Proceedings of the 2005 ACM SIGMOD International
	Conference on Management of Data. ---
	\newblock SIGMOD '05. ---
	\newblock New York, NY, USA~: ACM, 2005. ---
	\newblock P.~646--657. ---
	\newblock URL: \BibUrl{http://doi.acm.org/10.1145/1066157.1066231}.
	
	\bibitem{gupta97}
	\selectlanguageifdefined{english}
	\BibEmph{Gupta,~Himanshu}. Selection of Views to Materialize in a Data
	Warehouse [Text]~/ Himanshu~Gupta~// Proceedings of the 6th International
	Conference on Database Theory. ---
	\newblock ICDT '97. ---
	\newblock London, UK, UK~: Springer-Verlag, 1997. ---
	\newblock P.~98--112. ---
	\newblock URL: \BibUrl{http://dl.acm.org/citation.cfm?id=645502.656089}.
	
	\bibitem{gupta99}
	\selectlanguageifdefined{english}
	\BibEmph{Gupta,~Himanshu}. Selection of Views to Materialize Under a
	Maintenance Cost Constraint [Text]~/ Himanshu~Gupta, Inderpal~Singh~Mumick~//
	Proceedings of the 7th International Conference on Database Theory. ---
	\newblock ICDT '99. ---
	\newblock London, UK, UK~: Springer-Verlag, 1999. ---
	\newblock P.~453--470. ---
	\newblock URL: \BibUrl{http://dl.acm.org/citation.cfm?id=645503.656261}.
	
	\bibitem{hilbert}
	\selectlanguageifdefined{english}
	\BibEmph{Hilbert,~David}. Principles of Mathematical Logic [Text]~/
	...
	\bibitem{kalnis}
	\selectlanguageifdefined{english}
	\BibEmph{Kalnis,~Panos}. Proxy-Server Architectures for OLAP. [Text]~/
	Panos~Kalnis, Dimitris~Papadias~// SIGMOD Conference~/ Ed.\ by\
	...
	\bibitem{keller}
	\selectlanguageifdefined{english}
	\BibEmph{Keller,~Arthur~M.} A Predicate-based Caching Scheme for Client-Server
	Database Architectures [Text]~/ Arthur~M.~Keller, Julie~Basu~// \BibEmph{VLDB
		J.} ---
	\newblock 1996. ---
	\newblock Vol.~5, no.~1. ---
	\newblock P.~35--47.
	...
	\bibitem{mendelson}
	\selectlanguageifdefined{english}
	\BibEmph{Mendelson,~Elliott}. Introduction to Mathematical Logic [Text]~/
	Elliott~Mendelson. ---
	\newblock 5 edition. ---
	...
	\bibitem{mosin_zykin}
	\selectlanguageifdefined{english}
	\BibEmph{Mosin,~Sergey}. Truth space method for caching database queries
	[Text]~/ Sergey~Mosin, Sergey~Zykin~// \BibEmph{Modeling and Analysis of
		Information Systems}. ---
	\newblock 2015. ---
	\newblock Vol.~22, no.~2. ---
	\newblock P.~248--258.
	...
	\bibitem{olston}
	\selectlanguageifdefined{english}
	\BibEmph{Olston,~Chris}.
	\href{http://dx.doi.org/10.1145/872757.872825}{Adaptive Filters for
		Continuous Queries over Distributed Data Streams} [Text]~/ Chris~Olston,
	Jing~Jiang, Jennifer~Widom~// Proceedings of the 2003 ACM SIGMOD
	International Conference on Management of Data. ---
	\newblock SIGMOD '03. ---
	\newblock New York, NY, USA~: ACM, 2003. ---
	\newblock P.~563--574. ---
	\newblock URL: \BibUrl{http://doi.acm.org/10.1145/872757.872825}.
	
	\bibitem{chang}
	\selectlanguageifdefined{english}
	\BibEmph{Park,~Chang-Sup}. Usability-based caching of query results in OLAP
	...
	\bibitem{scheuermann}
	\selectlanguageifdefined{english}
	\BibEmph{Scheuermann,~Peter}. WATCHMAN: A Data Warehouse Intelligent Cache
	...
	\newblock P.~51--62. ---
	\newblock URL: \BibUrl{http://dl.acm.org/citation.cfm?id=645922.758367}.
	
	\bibitem{shim}
	\selectlanguageifdefined{english}
	\BibEmph{Shim,~Junho}. Dynamic Caching of Query Results for Decision Support
